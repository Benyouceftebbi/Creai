...
import { RefreshCw, Star, LogOut, ChevronDown, Menu } from "lucide-react"
  ...
  return (
    <div className="flex items-center justify-between gap-2 text-sm w-full">
      ...
      <div className="flex items-center gap-1.5 md:hidden relative">
        {/* Tokens Display - Always visible on mobile */}
        <div className="font-medium text-muted-foreground flex items-center gap-1 px-1.5 py-1 rounded-lg bg-gradient-to-r from-yellow-50 to-amber-50 dark:from-yellow-950/20 dark:to-amber-950/20 border border-yellow-200/50 dark:border-yellow-800/30">
          <Star className="h-3 w-3 text-yellow-500 fill-current" />
          <span className="font-bold text-foreground tabular-nums text-xs">{formattedTokens}</span>
        </div>
        ...
        <Button
          ...
          className={`
      relative overflow-hidden p-0 h-7 w-7
    ...
    `}
        ...
        {/* Power Up (Pricing Modal) - Mobile */}
        <div className="scale-75 relative z-40">
          <PricingModal />
        </div>
        ...
        {/* Language Switcher - Mobile - Fixed z-index and positioning */}
        <div className="scale-75 relative z-50 overflow-visible">
        ...
        <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
          ...
          <SheetContent side="right" className="w-80 p-0">
            <div className="flex flex-col h-full">
              ...
              <div className="p-6 bg-gradient-to-r from-purple-50/50 to-blue-50/50 dark:from-purple-950/20 dark:to-blue-950/20">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-bold text-foreground text-base truncate">{user?.displayName || "User"}</p>
              ...
              <div className="flex-1 p-4 space-y-4">
                {/* Tokens Display - Detailed view */}
                <div className="p-4 bg-gradient-to-r from-yellow-50/50 to-amber-50/50 dark:from-yellow-950/20 dark:to-amber-950/20 rounded-xl border border-yellow-200/50 dark:border-yellow-800/30">
                  <div className="flex items-center gap-3">
                ...
                {/* Remove PricingModal from here since it's now in the top bar */}
              </div>
              ...
              <div className="p-4 border-t">
                <Button
                  ...
                  variant="outline"
                  className="w-full justify-start gap-3 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/30 border-red-200 dark:border-red-800 bg-transparent"
                >
